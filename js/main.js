            ...
            <div class="pizza-card reveal" style="--i:${i % 6}">
              <div class="media">
                ...
                <div class="card-overlay">
                  ...
                  <button type="button" class="btn-add-overlay btn-add-overlay-full" data-add-cart data-id="${p.id}" data-name="${(p.name||"").replace(/"/g,'&quot;')}" data-price="${p.price||0}">افزودن +</button>
                </div>
              </div>
            </div>
          `;
