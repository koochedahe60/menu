/* ===========================================================
   کوچه دهه شصت — "turn on your VPN" hint
   -----------------------------------------------------------
   Some assets on this site (Google Fonts) live on domains that
   are sometimes filtered inside Iran. If a visitor's connection
   looks like it's coming from Iran directly (i.e. no VPN/anti-filter
   tool active), we show a small dismissible notice suggesting they
   turn one on for the smoothest experience.
  ...
  function showBanner(){
    ...
    bar.innerHTML = `
      ...
      <span style="flex:1;font-size:.85rem;line-height:1.6">
        برای تجربه بهتر و سریع‌تر (مثل لود شدن درست فونت‌ها)، بهتر است فیلترشکن خود را روشن کنید.
      </span>
